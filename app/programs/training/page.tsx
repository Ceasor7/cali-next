  ...
  return (
    ...
    >
      <div className="space-y-4">
        <p>
          CALI`&apos;`s training workshops are designed to build essential
          skills in various critical areas of the creative arts sector. Our
          programs focus on creative arts management, fundraising, marketing and
          audience development. We achieve this through a series of hands-on
          workshops and masterclasses tailored to meet the needs of artists,
          creative arts managers, and cultural practitioners.
        </p>
        <p>
